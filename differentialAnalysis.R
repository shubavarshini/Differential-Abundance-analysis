...
i=2
####Plotting counts####
cairo_pdf(file="./MG/logCPM_distribution_pca_rle_afterRUVg.pdf",bg="transparent",
...
####limma no RUVg####
cairo_pdf(file="./MG/pvalue_limma_noRUVg.pdf",bg="transparent",
...
dev.off()
####Heatmap
cairo_pdf(file="./MG/limma_noRUVg_sigHeatmap.pdf",bg="transparent",
...
cairo_pdf(file="./MG/limma_noRUVg_sig_logFC_logCPM_barPlots.pdf",bg="transparent",
...
####limma-voom no RUVg####
cairo_pdf(file="./MG/meanVariance_limmaVoom_noRUVg.pdf",bg="transparent",
...
dev.off()
####Heatmap
cairo_pdf(file="./MG/limmaVoom_noRUVg_sigHeatmap.pdf",bg="transparent",
          width = 5,height = 4,family = "Times New Roman")
...
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MG/limmaVoom_noRUVg_sig_logFC_logCPM_barPlots.pdf",bg="transparent",
          width = 4,height = 4,family = "Times New Roman")
logFC_barPlot <- ggplot(dge_limma,aes(x=reorder(defined_taxa,-logFC),y=logFC)) + 
  geom_col() + xlab(element_blank()) +
  theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
...
####voom limma####
cairo_pdf(file="./MG/meanVariance_limmaVoom_afterRUVg.pdf",bg="transparent",
          width = 8,height = 2.5,family = "Times New Roman")
par(mfrow = c(1, 3))
...
dev.off()
####limma####
cairo_pdf(file="./MG/pvalue_limma_afterRUVg.pdf",bg="transparent",
          width = 6,height = 3.5,family = "Times New Roman")
par(mfrow = c(1, 2))
...
dev.off()
####Heatmap
cairo_pdf(file="./MG/limma_afterRUVg_sigHeatmap.pdf",bg="transparent",
          width = 5,height = 4,family = "Times New Roman")
...
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MG/limma_afterRUVg_sig_logFC_logCPM_barPlots.pdf",bg="transparent",
          width = 4,height = 4,family = "Times New Roman")
logFC_barPlot <- ggplot(dge_limma,aes(x=reorder(defined_taxa,-logFC),y=logFC)) + 
  geom_col() + xlab(element_blank()) +
  theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
...
####edgeR####
cairo_pdf(file="./MG/pvalue_fdr_edgeR_afterRUVg.pdf",bg="transparent",
...
top_dna <- topTags(lrt, n=nrow(set))$table
hist(top_dna$PValue,breaks=20,main = paste("Histogram of P-value\nedgeR N=" , nrow(x_dna$counts)),
     xlab = "P-value")
hist(top_dna$FDR,breaks=20,main = paste("Histogram of FDR\nedgeR N=" , nrow(x_dna$counts)),
     xlab = "FDR")
plot(top_dna$logCPM, top_dna$logFC,main = paste("MA plot\nedgeR N=" , nrow(x_dna$counts)),
...
####Heatmap
cairo_pdf(file="./MG/edgeR_afterRUVg_sigHeatmap.pdf",bg="transparent",
          width = 5,height = 5,family = "Times New Roman")
dge_edgeR <- subset(top_dna,top_dna$PValue<=0.05 & top_dna$FDR <= 0.05 & (top_dna$logFC>=2|top_dna$logFC<=-2))
...
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MG/edgeR_afterRUVg_sig_logFC_logCPM_barPlots.pdf",bg="transparent",
          width = 4,height = 4,family = "Times New Roman")
...
i=2
####Plotting counts####
cairo_pdf(file="./MT/logCPM_distribution_pca_rle_afterRUVg.pdf",bg="transparent",
          width = 11,height = 2.5,family = "Times New Roman")
par(mfrow = c(1, 5))
a_logCPM <- data.frame(cbind("defined_taxa" =rownames(a),edgeR::cpm.default(a,log=T)), stringsAsFactors = FALSE)
m_a <- reshape2::melt(a_logCPM,value.name = "log_cpm",id.vars=c("defined_taxa"))
...
####limma no RUVg####
cairo_pdf(file="./MT/pvalue_limma_noRUVg.pdf",bg="transparent",
          width = 6,height = 3.5,family = "Times New Roman")
par(mfrow = c(1, 2))
...
####Heatmap
cairo_pdf(file="./MT/limma_noRUVg_sigHeatmap.pdf",bg="transparent",
...
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MT/limma_noRUVg_sig_logFC_logCPM_barPlots.pdf",bg="transparent",
          width = 5,height = 5,family = "Times New Roman")
logFC_barPlot <- ggplot(dge_limma,aes(x=reorder(defined_taxa,-logFC),y=logFC)) + 
  geom_col() + xlab(element_blank()) +
  theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
...
####limma-voom no RUVg####
cairo_pdf(file="./MT/meanVariance_limmaVoom_noRUVg.pdf",bg="transparent",
          width = 8,height = 2.5,family = "Times New Roman")
par(mfrow = c(1, 3))
logCPM_afterNormFac_rna <- edgeR::cpm(x_rna, log=TRUE)
row.names(logCPM_afterNormFac_rna) <- x_rna$genes$defined_taxa
...
hist(rna_top_table_limmaVoom_noruvg$adj.P.Val,breaks=20,main = paste("Histogram of adj.P-value\nLimma (No RUVg) N=" , nrow(x_rna$counts)),
     xlab = "adj.P-value")
hist(rna_top_table_limmaVoom_noruvg$logFC,breaks=50,main = paste("Histogram of logFC\nLimma N=" , nrow(x_rna$counts)),
     xlab = "logFC")
dev.off()
####Heatmap
cairo_pdf(file="./MT/limmaVoom_noRUVg_sigHeatmap.pdf",bg="transparent",
          width = 6,height = 5,family = "Times New Roman")
dge_limma <- subset(rna_top_table_limmaVoom_noruvg,rna_top_table_limmaVoom_noruvg$adj.P.Val<=0.1 & 
...
rownames(mat_rna) <- dge_limma[,1]
print(pheatmap(mat_rna, cluster_rows = F, cluster_cols = T,fontsize_row = 4,
               main = "Bi-clustering using hclust of log CPMs\nSignificant after limma Voom(No RUVg)"))
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MT/limmaVoom_noRUVg_sig_logFC_logCPM_barPlot.pdf",bg="transparent",
          width = 6,height = 5,family = "Times New Roman")
logFC_barPlot <- ggplot(dge_limma,aes(x=reorder(defined_taxa,-logFC),y=logFC)) + 
  geom_col() + xlab(element_blank()) +
  theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
...
dev.off()
####voom limma####
cairo_pdf(file="./MT/meanVariance_limmaVoom_afterRUVg.pdf",bg="transparent",
          width = 8,height = 2.5,family = "Times New Roman")
par(mfrow = c(1, 3))
design_voom <- cbind(design_ruvg,set2$W_1,set2$W_2)
colnames(design_voom) <- c("wt","mock","W_1","W_2")
...
dev.off()
####Heatmap
cairo_pdf(file="./MT/limmaVoom_afterRUVg_sigHeatmap.pdf",bg="transparent",
          width = 6,height = 5,family = "Times New Roman")
dge_limma <- subset(rna_top_table_limmaVoom,rna_top_table_limmaVoom$adj.P.Val<=0.1 & 
                      (rna_top_table_limmaVoom$logFC>=2|rna_top_table_limmaVoom$logFC<=-2))
dge_limma <- left_join(dge_limma,a_logCPM,by=c("defined_taxa"))
dge_limma <- dge_limma %>% mutate(across(colnames(dge_limma)[-1],as.numeric))
dge_limma <- dge_limma[order(dge_limma$logFC,decreasing = T), , drop = FALSE]
...
rownames(mat_rna) <- dge_limma[,1]
print(pheatmap(mat_rna, cluster_rows = F, cluster_cols = T,fontsize_row = 4,
               main = "Bi-clustering using hclust of log CPMs\nSignificant after limma Voom (after RUVg)"))
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MT/limmaVoom_afterRUVg_sig_logFC_logCPM_barPlot.pdf",bg="transparent",
          width = 6,height = 5,family = "Times New Roman")
logFC_barPlot <- ggplot(dge_limma,aes(x=reorder(defined_taxa,-logFC),y=logFC)) + 
  geom_col() + xlab(element_blank()) +
  theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
...
dev.off()
####limma####
cairo_pdf(file="./MT/pvalue_limma_afterRUVg.pdf",bg="transparent",
          width = 6,height = 3.5,family = "Times New Roman")
par(mfrow = c(1, 2))
log_counts_corrected <- sapply(corrected[,-1], as.numeric)
rownames(log_counts_corrected) <- corrected[,1]
...
dev.off()
####Heatmap
cairo_pdf(file="./MT/limma_afterRUVg_sigHeatmap.pdf",bg="transparent",
          width = 5,height = 4,family = "Times New Roman")
...
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MT/limma_afterRUVg_sig_logFC_logCPM_barPlots.pdf",bg="transparent",
          width = 4,height = 4,family = "Times New Roman")
logFC_barPlot <- ggplot(dge_limma,aes(x=reorder(defined_taxa,-logFC),y=logFC)) + 
  geom_col() + xlab(element_blank()) +
  theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
...
####edgeR####
cairo_pdf(file="./MT/pvalue_fdr_edgeR_afterRUVg.pdf",bg="transparent",
          width = 10,height = 2.5,family = "Times New Roman")
par(mfrow = c(1, 4))
...
fit <- glmFit(y, design_edgeR)
lrt <- glmLRT(fit, coef=2)
top_rna <- topTags(lrt, n=nrow(set))$table
hist(top_rna$PValue,breaks=20,main = paste("Histogram of P-value\nedgeR N=" , nrow(x_rna$counts)),
     xlab = "P-value")
hist(top_rna$FDR,breaks=20,main = paste("Histogram of FDR\nedgeR N=" , nrow(x_rna$counts)),
     xlab = "FDR")
plot(top_rna$logCPM, top_rna$logFC,main = paste("MA plot\nedgeR N=" , nrow(x_dna$counts)),
     xlab="Average log CPM", ylab="logFC",pch=20,cex=0.5)
...
####Heatmap
cairo_pdf(file="./MT/edgeR_afterRUVg_sigHeatmap.pdf",bg="transparent",
          width = 5,height = 6,family = "Times New Roman")
dge_edgeR <- subset(top_rna,top_rna$PValue<=0.05 & top_rna$FDR <= 0.05 & (top_rna$logFC>=2|top_rna$logFC<=-2))
dge_edgeR <- left_join(rownames_to_column(dge_edgeR,var = "defined_taxa"),a_logCPM,by=c("defined_taxa"))
dge_edgeR <- dge_edgeR %>% mutate(across(colnames(dge_edgeR)[-1],as.numeric))
dge_edgeR <- dge_edgeR[order(dge_edgeR$logFC,decreasing = T), , drop = FALSE]
...
dev.off()
####logFC and logCPM bar plots
cairo_pdf(file="./MT/edgeR_afterRUVg_sig_logFC_logCPM_barPlots.pdf",bg="transparent",
          width = 6,height = 5,family = "Times New Roman")
logFC_barPlot <- ggplot(dge_edgeR,aes(x=reorder(defined_taxa,-logFC),y=logFC)) + 
  geom_col() + xlab(element_blank()) +
  theme(axis.text.x = element_blank(),axis.ticks.x = element_blank())
